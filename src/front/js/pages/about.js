...
const About = () => {
  return (
    <div className="about-page-container">
      <div id="whole-wheat-about" className="container text-center whole-wheat">
        <style>
          @import
        ...
        <div id="rye">
          ...
          <p>
            Our mission is simple: to empower you to make informed decisions
            about your diet, without the stress or confusion. Whether you're
            striving for weight management, seeking to optimize your athletic
            performance, managing dietary restrictions, or simply aiming for a
            healthier lifestyle, NourishNav has you covered.
            ...
            insights into your daily macronutrient and micronutrient
            consumption. <h5 id="h5">Community Support:</h5> Connect with fellow
            health enthusiasts and nutrition experts through our vibrant
            community platform. Share recipes, tips, and success stories, and
            find the support you need to stay motivated.
            ...
            <p>
              ...
              easier. Join us on the journey to lifelong health and vitality.
